    ...
    <div ref={revealRef}>
      <section className="page-hero">
        <div className="container">
          ...
          <h1 className="page-hero-title">Hubungi <span className="text-accent">Kami</span></h1>
          <p className="page-hero-subtitle">Konsultasi gratis via WhatsApp atau kunjungi langsung toko kami.</p>
        </div>
      </section>
          ...
          <div className="contact-grid">
            <div className="contact-cards">
              <div className="contact-card animate-on-scroll">
                <div className="cc-icon cc-whatsapp">
                ...
                <a href="https://wa.me/6281234567890?text=Halo%20RLB%2C%20saya%20ingin%20konsultasi%20service%20LCD" className="btn btn-primary" target="_blank" rel="noopener noreferrer">Chat Sekarang</a>
              </div>
              ...
              <div className="contact-card animate-on-scroll">
                ...
                <a href="tel:+6281234567890" className="btn btn-outline">Hubungi</a>
              </div>
